...
export declare class MiddlewareContainer {
    ...
    getMiddlewareCollection(module: string): Map<string, InstanceWrapper>;
    getConfigurations(): Map<string, Set<MiddlewareConfiguration>>;
    insertConfig(configList: MiddlewareConfiguration[], module: string): void;
    private getTargetMiddleware;
